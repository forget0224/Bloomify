          ...
          <div className="mx-auto md:px-52 sm:24 space-y-10">
            <div className="flex justify-center my-16">
              <div className="flex flex-col items-center space-y-6">
                <div className="border border-solid rounded-full bg-primary w-10 h-10 flex justify-center items-center color-white w-24 h-24 lg:w-24 lg:h-24">
                  <IoMdCheckmark
                    className="w-20 h-20 lg:w-20 lg:h-20"
                    style={{ color: 'white' }}
                  />
                </div>
                <p className="text-2xl lg:text-3xl xl:text-4xl text-primary text-center px-4 lg:px-8">
                  付款成功，您的訂單已成立
                </p>
              </div>
            </div>
